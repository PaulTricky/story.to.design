...
const ProjectCard = ({ isMobile }) => {
  const tags = useMemo(() => {
    return isMobile ? ["Cyber Security", "Comp Functions", "+5"] :
    ["Cyber Security", "Safety", "z-call", "Comp Functions", "+5"]
  }, [isMobile]) ;
    ...
    <div className={styles.card}>
      <Row>
        <Col flex={"1"} className="flex gap-8">
          ...
          <div className="flex-column gap-8">
            ...
            <Tag className={styles.matchPercent} children={`40% match`} />
          </div>
        </Col>
        <Col flex={"67px"}>
      ...
      <Row className="mt-1-5rem">
        <Typography
          ...
          children={"Data Protection Expert Needed for Z-Call Functions"}
        />
      </Row>
